    ...
    <div class="detail-container">
        <div class="detail-content">
            ...
            <div class="detail-content-bottom">
                ...
                <div class="detail-related-product">
                    <div class="product-1">
                        <RouterLink to="/detail">
                            <img src="../assets/image/s23-1.png" alt="">
                    ...
                    <div class="product-1">
                        <RouterLink to="/detail">
                            <img src="../assets/image/ipad-1.png" alt="">
                            <p>iPad Pro 13</p>
                        </RouterLink>
                    </div>
                    ...
                    <div class="product-1">
                        <RouterLink to="/detail">
                            <img src="../assets/image/iwatch-1.png" alt="">
                            <p>iWatch Series 4</p>
                        </RouterLink>   
                    </div>
                    ...
                    <div class="product-1">
                        <RouterLink to="/detail">
                            <img src="../assets/image/airpod-1.png" alt="">
                            <p>AirPod Series 3</p>
                        </RouterLink>  
                    </div>
                    ...
                    <div class="product-1">
                        <RouterLink to="/detail">
                            <img src="../assets/image/ipen-1.png" alt="">
                            <p>iPen Pro 3</p>
                        </RouterLink>    
                    </div>
                </div>
